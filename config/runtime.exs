...
#
#     PHX_SERVER=true bin/hanguko start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :hanguko, HangukoWeb.Endpoint, server: true
end
  ...
  config :hanguko, HangukoWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/hanguko_web/router\.ex$"E,
        ~r"lib/hanguko_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
